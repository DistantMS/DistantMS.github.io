...
if(isset($_SESSION['id'])) {
	if(!isset($_POST['unstuck'])) {
		echo "Is your character stuck at a bugged map, and you can't login in? Or stuck in a tutorial/cutscene?<br/>Choose your character, and you will be moved to the Free Market! Make sure you're logged off first.<br /><br /><form method=\"POST\"><center><table border=\"0\" width=\"300\"><tr><td align=\"left\" width=\"50%\"><b>Select character:</b></td><td><select name=\"char\">";
